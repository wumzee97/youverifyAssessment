...
<template>
  ...
  <div class="  lg:fixed  z-40"  >
    <div class="absolute flex border-r border-[#ddd] h-full z-[999999999999] lg:mt-[2px] bg-white ] " >
    ...
    <transition name="fade" class="lg:hidden">
      ...
      <div
        ...
        class="flex-1 bg-primary bg-opacity-50 absolute lg:hidden  active:outline-none z-50 w-screen h-screen"
      />
    </transition>
  </div>
</template>
